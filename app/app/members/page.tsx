...
export default function Members() {
  return (
    <main style={{
      ...
      {/* DESCRIPTION */}
      <p style={{ color: "#888" }}>
        Full access to today’s system-qualified plays.
      </p>

      {/* PLAYS */}
      <h2 style={{ marginTop: "20px" }}>Today’s Plays</h2>

      {data.todaysPlays.length === 0 ? (
        <p style={{ color: "#888" }}>No qualified plays today</p>
      ) : (
